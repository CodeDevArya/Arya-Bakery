      ...
      >
        <div className="mainabt">
          ...
          ><div className="titlemain">
              <div className="tit">About Arya's Bakery</div>

              <div className="descabt">
                Welcome to Arya's Bakery, where our passion for baking meets your
          ...
          >
            <div className="titlemain">
              ...
              <div className="descabt">
                It all began with a dream and a pinch of flour. Himanshu, the
                founder of Arya's Bakery, started this journey with a
                ...
                quality, Himanshu set out to create a bakery that would become
          ...
          ><div className="titlemain">
              ...
              <div className="descabt">
                At Arya's Bakery, we believe that baking is not just a
